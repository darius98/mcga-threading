...
int main(int argc, char** argv) {
    ...
    StatefulWorkerThread<int&, vector<int>, const double&> statefulWorker(
      capture, capture2, capture3);
    StatefulWorkerThreadPool<int&, vector<int>, const double&>
      statefulWorkerPool(capture, capture2, capture3);
    ...
    StatefulSingleProducerWorkerThread<int&, vector<int>, const double&>
      spStatefulWorker(capture, capture2, capture3);
    StatefulSingleProducerWorkerThreadPool<int&, vector<int>, const double&>
      spStatefulWorkerPool(capture, capture2, capture3);
    ...
    cout << "\tWorker:                               "
         << sampleDuration(numSamples, task, worker) << "\n";
    cout << "\tStatelessEventLoop:                   "
         << sampleDuration(numSamples, task, statelessEventLoop) << "\n";
    cout << "\tStatelessWorker:                      "
         << sampleDuration(numSamples, task, statelessWorker) << "\n";
    cout << "\tSingleProducerEventLoop:              "
         << sampleDuration(numSamples, task, spEventLoop) << "\n";
    cout << "\tSingleProducerWorker:                 "
         << sampleDuration(numSamples, task, spWorker) << "\n";
    cout << "\tStatelessSingleProducerEventLoop:     "
         << sampleDuration(numSamples, task, spStatelessEventLoop) << "\n";
    cout << "\tStatelessSingleProducerWorker:        "
         << sampleDuration(numSamples, task, spStatelessWorker) << "\n";
    cout << "\n";
#ifdef LINK_EVPP
    ...
    cout << "\tWorkerPool:                           "
         << sampleDuration(numSamples, atomicTask, workerPool) << "\n";
    cout << "\tStatelessEventLoopPool:               "
         << sampleDuration(numSamples, atomicTask, statelessEventLoopPool)
         << "\n";
    cout << "\tStatelessWorkerPool:                  "
         << sampleDuration(numSamples, atomicTask, statelessWorkerPool) << "\n";
    cout << "\tSingleProducerEventLoopPool:          "
         << sampleDuration(numSamples, atomicTask, spEventLoopPool) << "\n";
    cout << "\tSingleProducerWorkerPool:             "
         << sampleDuration(numSamples, atomicTask, spWorkerPool) << "\n";
    cout << "\tStatelessSingleProducerEventLoopPool: "
         << sampleDuration(numSamples, atomicTask, spStatelessEventLoopPool)
         << "\n";
    cout << "\tStatelessSingleProducerWorkerPool:    "
         << sampleDuration(numSamples, atomicTask, spStatelessWorkerPool)
         << "\n";
    ...
    cout << "\tWorker:                               "
         << sampleDuration(numSamples, capturingLambda, worker) << "\n";
    cout << "\tStatefulEventLoop:                    "
         << sampleDuration(numSamples, parameterLambda, statefulEventLoop)
         << "\n";
    cout << "\tStatefulWorker:                       "
         << sampleDuration(numSamples, parameterLambda, statefulWorker) << "\n";
    cout << "\tSingleProducerEventLoop:              "
         << sampleDuration(numSamples, capturingLambda, spEventLoop) << "\n";
    cout << "\tSingleProducerWorker:                 "
         << sampleDuration(numSamples, capturingLambda, spWorker) << "\n";
    cout << "\tStatefulSingleProducerEventLoop:      "
         << sampleDuration(numSamples, parameterLambda, spStatefulEventLoop)
         << "\n";
    cout << "\tStatefulSingleProducerWorker:         "
         << sampleDuration(numSamples, parameterLambda, spStatefulWorker)
         << "\n";
    cout << "\n";
#ifdef LINK_EVPP
    cout << "\tEVPP EventLoopPool:                   "
    ...
    cout << "\tEventLoopPool:                        "
         ...
         << "\n";
    cout << "\tWorkerPool:                           "
         << sampleDuration(numSamples, atomicCapturingLambda, workerPool)
         << "\n";
    cout << "\tStatefulEventLoopPool:                "
         << sampleDuration(
              numSamples, atomicParameterLambda, statefulEventLoopPool)
         << "\n";
    cout << "\tStatefulWorkerPool:                   "
         << sampleDuration(
              numSamples, atomicParameterLambda, statefulWorkerPool)
         << "\n";
    cout << "\tSingleProducerEventLoopPool:          "
         << sampleDuration(numSamples, atomicCapturingLambda, spEventLoopPool)
         << "\n";
    cout << "\tSingleProducerWorkerPool:             "
         << sampleDuration(numSamples, atomicCapturingLambda, spWorkerPool)
         << "\n";
    cout << "\tStatefulSingleProducerEventLoopPool:  "
         << sampleDuration(
              numSamples, atomicParameterLambda, spStatefulEventLoopPool)
         << "\n";
    cout << "\tStatefulSingleProducerWorkerPool:     "
         << sampleDuration(
              numSamples, atomicParameterLambda, spStatefulWorkerPool)
         << "\n";
