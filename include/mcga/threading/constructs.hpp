...
using WorkerThreadConstruct
  = base::WorkerConstruct<base::ThreadWrapper<base::Worker<Processor>>>;

template<class Processor>
using SingleProducerWorkerThreadConstruct = base::WorkerConstruct<
  base::ThreadWrapper<base::SingleProducerWorker<Processor>>>;

template<class Processor>
using WorkerThreadPoolConstruct = base::WorkerConstruct<
  base::ThreadPoolWrapper<base::Worker<Processor>, std::atomic_size_t>>;

template<class Processor>
using SingleProducerWorkerThreadPoolConstruct = base::WorkerConstruct<
  base::ThreadPoolWrapper<base::SingleProducerWorker<Processor>, std::size_t>>;
